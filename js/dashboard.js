(function($) {
	...
	$(function() {
		var salesDifferencedata = {
			labels: ["Ahda", "Firly", "Barori", "Danur", "Wenda"],
			datasets: [{
		...
		$("#productorder-gage").append('<div class="product-order"><div class="icon-inside-circle" style="position: relative; margin-top: -10%"><i class="mdi mdi-basket"></i></div></div>');
